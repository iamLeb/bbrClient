    ...
    return (
        <div className="py-20">
            <div className="flex flex-col justify-between gap-4 text-center pb-9">
                ...
                <p className="font-light text-sm">Navigate through our detailed neighborhood profiles to find the
                    perfect balance of lifestyle and convenience.</p>
            </div>
            ...
            <div
                ...
                {galleries.map(gallery => (
                    <div key={gallery._id}
                         className="group sm:h-full sm:w-full relative overflow-hidden hover:cursor-pointer">
