...
<<<<<<< HEAD:src/components/FrontComponents/ContactTemplate.jsx
...
const ContactHero = () => {
  return (
    <section className={"py-9 px-5 bg-[#d5eaea]"}>
      <div
        className={"flex flex-col justify-around items-center pt-12 space-y-10"}
      >
        <div className={"flex flex-col space-y-12 sm:pl-20 "}>
          <div
            className={
              "flex flex-col justify-center w-full sm:w-1/2 text-black"
            }
          >
...
>>>>>>> bea916acb788bc2c297918f8ffa7a1ccc85c218d:src/components/FrontComponents/ContactHero.jsx
            </div>
          ...
          <div className={"bg-white rounded-lg shadow-2xl p-10"}>
            ...
            <form className={"flex flex-col gap-2"}>
              ...
              <div className={"flex-1"}>
                ...
                <textarea
                  className={
                    "resize-none px-3 focus:outline-primary border rounded-lg py-4 w-full placeholder:text-gray-500 text-sm"
                  }
                  cols="30"
                  rows="5"
              ...
              <div>
                <button className={"border  bg-primary rounded-lg py-4 w-full"}>
