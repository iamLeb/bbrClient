...
const Rent = () => {
    ...
    return (
        <section className={'mt-2 p-2 sm:p-9 bg-gradient-to-r from-white to-[#fdeccf]'}>
            <div className={'flex flex-col justify-center items-center gap-5'}>
                <div className={'flex flex-col justify-between gap-4 text-center'}>
                    <h1 className={'font-bold text-3xl sm:text-5xl'}>Properties For Rent</h1>
                    <p className={'font-light text-sm'}>Search over 1000 properties to rent from the top agents in the country</p>
                </div>
            </div>
            ...
            <div className={'px-2 mt-5'}>
                <div className={'grid grid-cols-1 sm:grid-cols-2 md:grid-col-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'}>
                    {featured.map(feat => (
                        <div key={feat.id} className={'bg-white p-3 rounded-lg shadow-md'}>
            ...
            <div className="text-center py-6">
                <button className={'bg-primary text-white font-medium py-2 px-5 rounded-full'}>View More</button>
            </div>
        </section>
    );
};
