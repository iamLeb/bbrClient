            ...
            <div className={'px-5 flex flex-col space-y-4 md:space-y-12'}>
                <div className={'flex flex-col space-y-4 md:space-y-2 md:flex-row md:space-x-20'}>
                    <div className={'bg-primary p-10 rounded-lg md:w-1/2'}>
                        ...
                        <p className={'text-black'}>We are committed to delivering exceptional service and exceeding our
                            clients' expectations at
                            every touchpoint</p>
                    </div>

                    <div className={'bg-primary p-10 rounded-lg md:w-1/2'}>
                        <p className={'text-white'}>Integrity</p>
                        <p className={'text-black'}>Honesty, transparency, and ethical conduct are the cornerstones of
                            our
                ...
                <div className={'flex flex-col space-y-2 md:flex-row md:space-x-20'}>
                    ...
                    <div className={'bg-primary  p-10 rounded-lg md:w-1/2'}>
                        ...
                        <p className={'text-black'}>Embracing technology and innovation enables us to streamline
                            processes, enhance efficiency, and deliver superior results.</p>
                    </div>
                </div>
