    ...
    return (
        <section className="relative pb-20">
            <div
                ...
                <div className={'flex justify-center items-center h-[600px] text-white relative'}>
                    <div className={'flex flex-col gap-2 items-center'}>
                        <div className={'flex space-x-4 items-center'}>
                            <FaHouseChimney/>
                            <p>Real Estate Agency</p>
                        </div>
                        <h1 className={'text-6xl text-center font-bold'}>Find your dream <br/> house by us</h1>
                ...
                <div
                    ...
                    <div className={'flex space-x-4'}>
                        ...
                        <button className={'bg-primary text-white w-full'}>Find Now</button>
                    </div>
                </div>
            </div>
        </section>
